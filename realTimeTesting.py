...
def main():
    ...
    classGest = ['11', '12', '13', '5', '8']
    #class_weight = {1: 0, 11: 1., 12: 1., 13: 1., 4: 0, 5: 0, 7:1., 8:1.}
    #nameGest = ['call', 'back', 'scroll up', 'scroll down', 'close 4', 'close 5', 'click 7', 'click 8']
    nameGest = ['back', 'scroll up', 'scroll down', 'close 5', 'click 8']
    delayGest = 10
    delayBol = False
    ...
    json_file = open('3dcnnresult/26/3dcnnmodel.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)

    # load weights into new model
    loaded_model.load_weights("3dcnnresult/26/3dcnnmodel.hd5")
