...
def main():
    ...
    json_file = open('3dcnnresult/38/3dcnnmodel.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)

    # load weights into new model
    loaded_model.load_weights("3dcnnresult/38/3dcnnmodel.hd5")
    ...
    face_cascadeL = cv2.CascadeClassifier('G:/opencv/opencv-master/data/lbpcascades/lbpcascade_frontalface.xml')
